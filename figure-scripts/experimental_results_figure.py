...
def load_experimental_data():
    with open("pkl-files/crystalline_CeO2.pkl", "rb") as f:
    ...
    with open("pkl-files/crystalline_Si.pkl", "rb") as f:
    ...
    with open("pkl-files/crystalline_Fe2O3.pkl", "rb") as f:
    ...
    with open("pkl-files/particles_CeO2_ID5.pkl", "rb") as f:
